...
\begin{prob}
	...
	\begin{enumerate}[(a)]
		...
		\item \textbf{Find the magnitude of the tension in the cable.}\\
		      \underline{\textbf {\bm{$m_{1}$}:}}
		      \begin{solution}
			      \vec{F_{net_{1x}}}            & = 0                                                              \\
			      0                             & = \left\lvert F_{T}\right\rvert - \vec{F_{g_{x}}}  \\
			      0                             & = \left\lvert F_{T}\right\rvert - 380(9.8) \sin 18 \degree      \\
		...
		\item \textbf{Calculate the mass of \bm{$m_{2}$} needed to keep the system in equilibrium.}
		      ...
		      \begin{solution}
			      ...
			      0 &= 1150.78 - m_{2}(9.8)\sin33\degree\\
	...
	\begin{enumerate}[(a)]
		\item \textbf{What will be the horizontal acceleration of the bale?}
		      \begin{solution}
			      ...
			      & = 66.81~\text{N[forward]}         &\tab \vec{a}           & = 1.96\text{m/s\textsuperscript{2}[forward]} \\
			      &                                 &\tab \vec{a}           & = 2.0~\text{m/s\textsuperscript{2}[forward]}
		      \end{solution}
		      $\therefore$ The horizontal acceleration of the bale is 2.0 m/s\textsuperscript{2}[forward].
		      \newpage
		\item \textbf{What is the coefficient of friction between the bale and the ground?}
		      \begin{solution}
			      ...
			      \mu_{f} &= \frac{55}{35(9.8)-140\sin 28\degree}\\
			      \mu_{f} &= 0.198\\
			      \mu_{f} &= 0.20
		      \end{solution}
	...
	\begin{enumerate}[(a)]
		...
		\item \textbf{What minimum force, \bm{$F$}, would be  necessary to move the box up the ramp at a constant speed?}
		      \begin{solution}
			      ...
			      0 &= \vec{F_{a}} - 194.31\\
			      \vec{F_{a}} &= 194.31~\text{N[uphill]}\\
			      \vec{F_{a}} &= 190~\text{N[uphill]}
		      \end{solution}
...
\begin{minipage}[t]{0.5\textwidth}
	...
	\begin{flalign*}
		...
		\mu_{f}     & = \frac{0.9}{0.45(9.8)\cos35\degree}    \\
		\mu_{f}     & = 0.249                                 \\
		\mu_{f}     & = 0.25
	\end{flalign*}
\end{minipage}\\
