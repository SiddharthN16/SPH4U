...
\begin{prob}
	...
	\begin{enumerate}[(a)]
		...
		\item \textbf{Find the magnitude of the tension in the cable.}\\
		      ...
		      \end{solution}
		      \framebox{$\therefore$ The magnitude of tension in the string is \textbf{1200 N}.}
	...
	\begin{enumerate}[(a)]
		\item \textbf{What will be the horizontal acceleration of the bale?}
		      \begin{solution}
			      ...
			      & = 140 \cos 28\degree - 55       &\tab 68.81             & = 35\vec{a}                                \\
			      & = 68.81~\text{N[forward]}         &\tab \vec{a}           & = 1.96\text{m/s\textsuperscript{2}[forward]} \\
			      &                                 &\tab \vec{a}           & = 2.0~\text{m/s\textsuperscript{2}[forward]}
		      \end{solution}
		      \framebox{$\therefore$ The horizontal acceleration of the bale is \textbf{2.0 m/s\textsuperscript{2}[forward].}}
		      \newpage
